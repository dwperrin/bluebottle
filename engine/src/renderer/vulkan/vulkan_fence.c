    ...
    if (!fence->is_signaled) {
        ...
        switch (result) {
            case VK_SUCCESS:
                ...
                return TRUE;
            case VK_TIMEOUT:
                BBWARN("vk_fence_wait - Timed out");
                break;
            case VK_ERROR_DEVICE_LOST:
                BBERROR("vk_fence_wait - VK_ERROR_DEVICE_LOST.");
                break;
            case VK_ERROR_OUT_OF_HOST_MEMORY:
                BBERROR("vk_fence_wait - VK_ERROR_OUT_OF_HOST_MEMORY.");
                break;
            case VK_ERROR_OUT_OF_DEVICE_MEMORY:
                BBERROR("vk_fence_wait - VK_ERROR_OUT_OF_DEVICE_MEMORY.");
                break;
            default:
                BBERROR("vk_fence_wait - An unknown error has occurred.");
                break;
        }
    } else {
