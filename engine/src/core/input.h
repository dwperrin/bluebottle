...
typedef enum keys {
    ...
    DEFINE_KEY(EXECUTES, 0x2B),  // NOTE: renamed EXECUTES to avoid conflicting defines in winnt.h
...
// keyboard input
BBAPI b8 input_is_key_down(keys key);
BBAPI b8 input_is_key_up(keys key);
BBAPI b8 input_was_key_down(keys key);
BBAPI b8 input_was_key_up(keys key);

void input_process_key(keys key, b8 pressed);

BBAPI b8 input_is_button_down(buttons button);
BBAPI b8 input_is_button_up(buttons button);
BBAPI b8 input_was_button_down(buttons button);
BBAPI b8 input_was_button_up(buttons button);
BBAPI void input_get_mouse_position(i32* x, i32* y);
BBAPI void input_get_previous_mouse_position(i32* x, i32* y);
