...
void log_output(log_level level, const char *message, ...) {
    ...
    // NOTE: Oddly enough, MS's headers override GCC/Clang va_list type with a "typedef char * va_list" in some
    // cases, and as a result throws stange error here. The workaround for now is to just use __builtin_va_list,
