 ...
 * @returns TRUE if the event is successfully registered; other FALSE;
*/
BBAPI b8 event_register(u16 code, void *listener, PFN_on_event on_event);

/**
 * Unregister to listening for when events are sent with the provided code. If no matching
 ...
 * @returns TRUE if the event is successfully unregistered; other FALSE;
*/
BBAPI b8 event_unregister(u16 code, void *listener, PFN_on_event on_event);
...
*/
BBAPI b8 event_fire(u16 code, void *sender, event_context context);
